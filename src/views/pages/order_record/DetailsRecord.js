...
function fetchCustomers(){
  ...
  <div className="card-body">
    <div className="container mb-5 mt-3">
      <div className="row d-flex align-items-baseline">
        <div className="col-xl-9">
          <p style={{color:"#7e8d9f",fontSize:"20px"}}>Invoice <strong>ID:6 #</strong></p>
        </div>
    ...
    <li>
      <span className="text-muted">To: <span style={{color:"#5d9fc5"}}>Md Habibur Rahman</span></span>
      <br />
      <span className="text-muted">Street:Dhaka</span>
      <br />
      <span className="text-muted">State, Bangladesh</span>
      <br />
      <span className="text-muted"><SettingsPhoneIcon/>01518389862</span>
    </li>
{/* //   ))} */}
  </ul>
          ...
          <div className="col-xl-4">
            ...
            <ul className="list-unstyled">
              <li className="text-muted"><span><CircleIcon style={{color:"#FFC107 "}}/>ID:6</span>#</li>
        ...
        <div className="row">
          ...
          <div className="col-xl-3" style={{marginTop:"30px"}}>
            <ul className="list-unstyled" >
              <li className="text-muted ms-3"><span className="text-black me-4">SubTotal</span>10000Tk</li>
              <li className="text-muted ms-3 mt-2"><span className="text-black me-4">Tax(10%)</span>100Tk</li>
            </ul>
            <p className="text-black float-start"><span className="text-black me-3" style={{marginLeft:"15px"}}> Total </span><span
                style={{fontSize: "20px"}}>10,100Tk</span></p>
          </div>
        </div>
