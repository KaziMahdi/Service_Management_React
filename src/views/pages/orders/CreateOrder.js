      ...
      <Table striped bordered hover size="sm" >
        ...
        {showForm && (
          <tr style={{ backgroundColor: "orange" }}>
            ...
            <td><Form.Control type="text" value={mobile} onChange={e => setMobile(e.target.value)} /></td>
            <td><Form.Control type="text" value={address} onChange={e => setAddress(e.target.value)}/></td>
            <td><Form.Control type="text" value={email} onChange={e => setEmail(e.target.value)}/></td>
